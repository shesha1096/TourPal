...
import com.example.shesha.tourpal.ListUsersActivity;
...
public class ListUsersAdapter extends BaseAdapter {
    ...
    private List<QBUser> qbUserArrayList;

    public ListUsersAdapter(ListUsersActivity context, List<QBUser> userWithoutCurrent) {
        this.context = context;
        qbUserArrayList =  userWithoutCurrent;
    }
